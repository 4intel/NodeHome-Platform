package net.fourintel.svm.common.web;
...
public class ComIndexController {
	...
	public String login(HttpServletRequest request, ModelMap model) throws UnknownHostException, IOException {
		return "svm/user/login";
	}
	
	@RequestMapping("/user/join")
	public String join(ModelMap model) throws UnknownHostException, IOException {
		return "svm/user/join";
	}
